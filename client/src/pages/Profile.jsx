...
export default function Profile() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-12">
      {/* Profile Banner Card */}
      <div className="relative rounded-2xl border border-border bg-white dark:bg-neutral-900 shadow-sm overflow-hidden">
        {/* Cover gradient */}
        <div className="h-32 sm:h-40 bg-gradient-to-r from-neutral-900 via-neutral-800 to-neutral-950 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950 relative">
            ...
            <div className="flex items-end gap-4">
              <div className="relative">
                {profileData?.photoURL || user?.photoURL ? (
                  <img
                    ...
                    className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl object-cover border-4 border-white dark:border-neutral-900 shadow-md bg-neutral-100"
                  />
                ) : (
              ...
              <div className="mb-1">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="text-xs font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-accent/10 text-accent border border-accent/20">
                    {role}
                  </span>
                </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="p-6 rounded-2xl border border-border bg-white dark:bg-neutral-900 shadow-sm">
            ...
            {isEditing ? (
              ...
              <div className="space-y-4">
                {/* Display Name */}
                <div className="flex items-center justify-between p-3.5 rounded-xl border border-border bg-neutral-50/50 dark:bg-neutral-950/40">
          ...
          <div className="p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-500/5">
          ...
          <div className="p-5 rounded-2xl border border-border bg-white dark:bg-neutral-900 shadow-sm space-y-3">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="p-6 rounded-2xl border border-border bg-white dark:bg-neutral-900 shadow-sm">
            ...
            {/* Streak Calendar */}
            <div className="p-4 rounded-xl border border-border bg-neutral-50/50 dark:bg-neutral-950/40">
